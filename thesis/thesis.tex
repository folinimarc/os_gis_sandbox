...
\begin{itemize}
  ...
  JupyterLab with various pre-installed python packages from the geo-ecosystem
...
to contradict the basic idea of isolation but proves to be useful in
...
Upon starting the sandbox, Docker Compose will check for the availability of the
