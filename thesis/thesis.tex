...
\begin{titlepage}
  ...
  \begin{abstract}
    ...
    participants to fully focus on how different applications interact to
    transform raw data into meaningful results. This is in contrast to many
    other tutorials, to which data is secondary to teach the tool-centered
    functionalities in a narrow scope. Built upon the capabilities of the
    Sandbox an example data story was conceptualized and implemented to create a
...
Secondly, todays's GIS ecosystem is extensive and fast evolving with multiple
tools addressing similar use cases with varying overlap in functionality. Many
...
It is hypothesized here that there is a content gap between what people
new to the field need and what is widely available.
