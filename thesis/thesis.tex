...
own purposes. An example could include a lightning talk at a GIS conference.

Finally, it is the hope of the author that the easy access to a range of
powerful open-source software could be an inspiration and foundation for a
dedicated course module on the importance, challenges and current state of the
GIS open-source ecosystem. Such a module could provide insights into the nature
of open-source beyond treating it as free-but-hardly-usable alternatives to
commercial products as it is the case in some of today's GIS university courses.
