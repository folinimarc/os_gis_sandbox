...
connected to get a desirable bigger picture. Imagine how frustrating
such a puzzle is to solve.

Data stories aim to bridge the above-mentioned gap and to put emphasis on the
fact how the puzzle pieces relate to each other. A data story provides selected
raw data, a motivating tangible goal and instructions that connect the raw data
to the goal. It allows to fully focus on how the different tools interact with
the data and other tools to achieve a meaningful result.
...
dataset to be consumed and styled in QGIS\cite{qgis}.

The data story can be found under \emph{\_datastories/bike\_suitability\_zurich}
in the geoscriptingsandbox.
