...
\usepackage{pdfpages} % To add PDF of declaration of originality at the end

% Set main font to a custom font
...
\emph{sandbox\_content/datastories/bike\_suitability\_zurich} in
...
%-------------
\includepdf{./img/declarationoforiginality.pdf}
