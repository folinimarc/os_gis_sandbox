...
\subsubsection*{Sandbox project names}
The -p flag used in the commands above specify the Docker Compose project name,
which is used as a prefix for many Docker Compose components such as networks
and volumes. It is therefore possible for multiple instances of the Sandbox with
separate volumes, and thus separate persisted state, to coexist by choosing
