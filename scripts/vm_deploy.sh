...
sed -i "s/OSGS_HOSTNAME=[^ ]*/OSGS_HOSTNAME=${HOSTNAME}/" sandbox.deploy.conf
sed -i "s/OSGS_USERNAME=[^ ]*/OSGS_USERNAME=${USERNAME}/" sandbox.conf
sed -i "s/OSGS_PASSWORD=[^ ]*/OSGS_PASSWORD=${PASSWORD}/" sandbox.conf
